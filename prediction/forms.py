...
class PredictionForm(forms.Form):
    ...
    blood_pressure = forms.ChoiceField(widget=forms.RadioSelect, choices=bp_choice)
    ...
    sound_sleep_hours = forms.IntegerField()
    ...
    class Meta:
        model = Profile
        field = ['age','gen','fam','bp','phy','bmi','smoking','alc','sleep','sound_sleep','med','junk','stress','bpl','preg','uri']
